...
namespace Scissors.ExpressApp.Console.Templates
{
	...
	public static class MessageBoxEx
    {
        ...
        public static int Query(int width, int height, string title, string message, params string[] buttons)
            => QueryFull(false, width, height, title, message, buttons);
        ...
        public static int ErrorQuery(int width, int height, string title, string message, params string[] buttons)
            => QueryFull(true, width, height, title, message, buttons);
        ...
        private static int QueryFull(bool useErrorColors, int width, int height, string title, string message, params string[] buttons)
        {
            ...
            var d = new DialogEx(title, width, height);
            var state = Application.Begin(d);
            ...
            d.SetNeedsDisplay(d.Bounds);

            Application.RunLoop(state, true);
